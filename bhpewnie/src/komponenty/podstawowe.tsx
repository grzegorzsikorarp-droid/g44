...
const SCIEZKI: Record<string, ReactNode> = {
  ...
  platek: <path d="M12 2.6v18.8M4.1 7.1l15.8 9.1M19.9 7.1 4.1 16.2M12 6l-2.2-2.2M12 6l2.2-2.2M12 18l-2.2 2.2M12 18l2.2 2.2M6.9 9.1 3.9 9.5M6.9 9.1 5.9 6.2M17.1 14.2l3 -0.4M17.1 14.2l1 2.9M17.1 9.1l3-0.4M17.1 9.1l1-2.9M6.9 14.2l-3 0.4M6.9 14.2l-1 2.9" />,
