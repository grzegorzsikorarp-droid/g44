...
Stan na 3 września 2026. Dotyczy pliku `System BHPewnie v2.dc.html`. Wpisy (a)–(h) pochodzą z wydania 1.1, (i)–(k) z profesjonalizacji oprawy, (l)–(s) z wydania 1.2 — odpowiedzi na `ZLECENIE_DESIGN_1_2.md`. Plik `System BHPewnie.dc.html` to wydanie pierwsze, zachowane bez zmian.
